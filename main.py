...
sleep(6)
print('\n'*1)
print('You\'ve been in that dark town jail cell long enough and that sunlight means freedom.')
sleep(6)
print('\n'*1)
print('There are two things you know for sure: the first is when opportunity knocks you have to answer --- so when that forgetful sheriff left your cell door unlocked before taking a nap you answered.')
sleep(6)
print('\n'*1)
print('The second thing you know: you need to...')
sleep(3)
